...
{
$rs=mysqli_query($connect, "select * from mst_subject where sub_name='$subname'");
if (mysqli_num_rows($rs)>0)
{
	echo "<br><br><br><div class=head1>Subject is Already Exists</div>";
	exit;
}
mysqli_query($connect,"insert into mst_subject(sub_name) values ('$subname')") or die(mysqli_error());
  ...
  <table width="41%"  border="0" align="center">
    <tr>
      ...
      <td width="53%" height="32">
        <input name="subname" placeholder="Subject Title" type="text" id="subname">
    <tr>
        <td height="26"> </td>
        <td>&nbsp;</td>
	  <td>&nbsp;</td>
