...
{
extract($_POST);
mysqli_query($connect,"insert into mst_question(test_id,que_desc,ans1,ans2,ans3,ans4,true_ans) values ('$testid','$addque','$ans1','$ans2','$ans3','$ans4','$anstrue')") or die(mysqli_error());
...
<?php
$rs=mysqli_query($connect,"Select * from mst_test order by test_name");
