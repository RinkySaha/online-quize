...
if(isset($submit))
{
	...
	$rs=mysqli_query($connect, "select * from mst_admin where loginid='$loginid' and pass='$pass'") or die(mysqli_error());
...
<p class="style7"><a href="testadd.php">Add Examination</a></p>
