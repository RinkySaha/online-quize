...
{
extract($_POST);
mysqli_query($connect, "insert into mst_test(sub_id,test_name,total_que) values ('$subid','$testname','$totque')") or die(mysqli_error());
...
<?php
$rs=mysqli_query($connect,"Select * from mst_subject order by  sub_name");
